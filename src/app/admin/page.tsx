...
export default async function AdminDashboard() {
  const [orderCount, productCount, pendingSync, lowStock, recentOrders, recentLogs] =
    await Promise.all([
      prisma.order.count(),
  ...
  const cards = [
    { label: "Đơn hàng", value: orderCount, href: "/admin/orders" },
    { label: "Sản phẩm", value: productCount, href: "/admin/products" },
    { label: "Cần sync Sapo", value: pendingSync, href: "/admin/orders" },
    { label: "Tồn thấp (≤5)", value: lowStock, href: "/admin/products" },
  ];
